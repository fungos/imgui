...
bool ImGui::BeginTitleMenuBar(const char *title, bool* p_open)
{
	...
	ImGuiWindowFlags window_flags = ImGuiWindowFlags_TitleMenuBar | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoDocking /*| ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove*/ | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_MenuBar;
