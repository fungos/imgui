...
public:
    ...
    float       MenuBarHeight() const                   { return (Flags & ImGuiWindowFlags_TitleMenuBar) ? 0.0f : (Flags & ImGuiWindowFlags_MenuBar) ? DC.MenuBarOffset.y + CalcFontSize() + GImGui->Style.FramePadding.y * 2.0f : 0.0f; }
