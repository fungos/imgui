...
bool ImGui::BeginMainMenuBar()
{
    ...
    SetNextWindowPos(ImGui::GetMainViewportPos());
    SetNextWindowSize(ImVec2(ImGui::GetMainViewportSize().x, g.NextWindowData.MenuBarOffsetMinVal.y + g.FontBaseSize + g.Style.FramePadding.y));
    SetNextWindowMainViewport(); // Enforce viewport so we don't create our onw viewport when ImGuiConfigFlags_ViewportsNoMerge is set.
